    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.img}><Ionicons name="medical" size={28} color="#fff" /></View>
          <View style={styles.info}>
            <Text style={styles.name}>Insulina 100 UI/mL</Text>
            <Text style={styles.uso}>Uso:</Text>
            <Text style={styles.desc}>Controle da glicemia em pacientes com...</Text>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.primary, borderRadius: radius.lg, padding: spacing.md, flexDirection: 'row', gap: spacing.sm },
  img: { width: 56, height: 56, borderRadius: radius.sm, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
  info: { flex: 1 },
